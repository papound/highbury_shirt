...
16. รูปแบบแสดงผลเมื่อค้นหาสินค้า:
    ...
    - หากไซส์ใดสต็อกเป็น 0 ตัว ให้เขียนระบุว่า "(ไม่มีสินค้า)" ห้ามพิมพ์คำว่า "0 ชิ้น", "0 ตัว" หรือ "สต็อก 0" เด็ดขาด
`;
